...
public class ImprovedSelectionManager : MonoBehaviour
{
    ...
    void UpdateDefaultMaterial()
    {
        ...
        if (Physics.Raycast(ray, out hit, 1.5f))
        {
            ...
            {
                GameObject currentCanvasPicture = hit.collider.gameObject;
                ImageOnObject imageOnObject = currentCanvasPicture.GetComponent<ImageOnObject>();

                if (imageOnObject == null)
                {
                    savedDefaultMaterial = defaultMaterial;
                }

                else
                {
                    savedDefaultMaterial = imageOnObject.ImageMaterial;
                }
    ...
    void HighlightSelectedObject()
    {
        ...
        if (_selection != null)
        {
            ...
            selectionRenderer.material = savedDefaultMaterial; //set material to default material
            _selection = null;
